...
elseif(COMPILER_TOOLCHAIN STREQUAL "clang")
    ...
    # cp hedef klasoru yaratmaz (cmake -E copy yaratirdi); mkdir ayri
    # KOMUT cunku ";" ve "{}" bu modulde COMMAND icinde bolunuyor.
    set(mpv_copy_debug COMMAND bash -c "[ ! -f <BINARY_DIR>/mpv.pdb ] || mkdir -p ${CMAKE_CURRENT_BINARY_DIR}/mpv-debug"
                       COMMAND bash -c "[ ! -f <BINARY_DIR>/mpv.pdb ] || cp <BINARY_DIR>/mpv.pdb ${CMAKE_CURRENT_BINARY_DIR}/mpv-debug/mpv.pdb")
    if(CLANG_PACKAGES_LTO)
        ...
        # (102)", 32646878919) ve libdovi tasiyan her link testi dusuyordu.
        # Duz makine kodu rlib icin bayraklar bos.
        set(cargo_lto_rustflags "")
